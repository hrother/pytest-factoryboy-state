# -*- coding: utf-8 -*-
#
# pytest-factoryboy-state documentation build configuration file, created by
...
project = 'pytest-factoryboy-state'
copyright = '2015, Holger Rother'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-factoryboy-state Documentation',
     [author], 1)
]
